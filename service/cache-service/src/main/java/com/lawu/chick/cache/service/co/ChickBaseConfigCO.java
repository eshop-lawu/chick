 ...
 * @date 2018年4月25日
 */
public class ChickBaseConfigCO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 857402765811590178L;
	/**
	 * 小鸡默认名称
	 */
...
/*	public int getChickDeclineMinusJoyfulVal() {
		return chickDeclineMinusJoyfulVal;
	}

	public void setChickDeclineMinusJoyfulVal(int chickDeclineMinusJoyfulVal) {
		this.chickDeclineMinusJoyfulVal = chickDeclineMinusJoyfulVal;
	}*/
