...
import com.lawu.chick.operator.repository.domain.UserDOExample;
...
import com.lawu.chick.operator.repository.mapper.UserDOMapper;
import com.lawu.chick.operator.repository.mapper.extend.RolePermissionDOMapperExtend;
import com.lawu.chick.operator.repository.mapper.extend.UserRoleDOMapperExtend;
...
import com.lawu.chick.operator.service.converter.UserConverter;
...
import com.lawu.chick.operator.service.strategy.PasswordStrategy;
...
public class UserServiceImpl implements UserService {
    ...
    public Page<UserListBO> findUserList(UserPageParam pageParam) {
        ...
        int count = (int) userDOMapper.countByExample(example);
