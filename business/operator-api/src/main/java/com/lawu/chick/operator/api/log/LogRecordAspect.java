package com.lawu.chick.operator.api.log;
...
import com.lawu.chick.operator.api.event.LoginEventPublisher;
...
public class LogRecordAspect {
	...
	@Pointcut("execution(* *(..)) && @annotation(com.lawu.chick.operator.api.log.LogRecord)")
