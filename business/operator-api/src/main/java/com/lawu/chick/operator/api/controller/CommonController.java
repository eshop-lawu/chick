...
import com.lawu.chick.operator.api.dto.CurrentUserDTO;
...
public class CommonController extends BaseController {
    ...
    @ApiOperation(value = "登录", notes = "根据账号密码登录。[3000]（章勇）", httpMethod = "GET")
    ...
    @ApiOperation(value = "退出", notes = "退出登录。（章勇）", httpMethod = "DELETE")
    ...
    @ApiOperation(value = "获取当前用户信息", notes = "获取当前用户信息。（章勇）", httpMethod = "GET")
