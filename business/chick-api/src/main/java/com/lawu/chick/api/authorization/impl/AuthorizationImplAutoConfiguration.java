 ...
 */
@Configuration
@ConditionalOnProperty(value = "lawu.authorization-impl.token-cache.enabled", havingValue = "true", matchIfMissing = false)
public class AuthorizationImplAutoConfiguration {
    
    @ConfigurationProperties(prefix = "lawu.authorization-impl.token-cache")
    @Bean
